...
> ¿Cuál es la probabilidad de tener hiperglucemia `(Ga > 100 mg/dL)`dado alta exposición a PM2-5 `(P >= 150µg/m^3)` ?

$$
\mathbb{P}\big( Ga > 100 \;\big|\; P \geq 150 \big)
$$
```{r}
set.seed(123)
...
¿Cuál es la probabilidad de tener pre-diabetes dado que existe una exposición alta de NOx y PM_2_5?

$$
\mathbb{P}\big( Hb > 5.6, Hb < 6.5  \;\big|\; N \geq 400 , P \geq 300 \big)
$$
```{r}
set.seed(123)
...
prob_query
```
> La probabilidad siendo de 0.21681
